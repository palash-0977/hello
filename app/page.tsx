  ...
  useEffect(() => {
    ...
    const checkUser = async () => {
      try {
        ...
        setTimeout(() => {
          if (data.user) router.replace("/messages");
    ...
    <main className="relative flex h-screen items-center justify-center overflow-hidden bg-[#050505]">
      ...
      <div className="relative z-10 flex w-[380px] flex-col items-center rounded-[32px] border border-white/10 bg-white/[0.04] px-10 py-12 backdrop-blur-3xl">
        ...
        <div className="relative mb-8">
          {/* Glow layers matching the logo colours */}
          <div className="absolute inset-0 scale-110 rounded-full bg-cyan-400/25 blur-2xl" />
          <div className="absolute inset-0 scale-125 rounded-full bg-sky-300/15 blur-3xl" />

          {/* The circle — overflow-hidden clips the PNG into a perfect circle */}
        ...
        {/* Title */}
        <h1 className="text-5xl font-bold tracking-tight text-white">Kivo</h1>
        <p className="mt-2 text-sm text-zinc-400">Fast • Secure • Connected</p>
        ...
        <div className="mt-10 flex flex-col items-center">
          <p className="text-[10px] uppercase tracking-[0.4em] text-zinc-600">Powered By</p>
